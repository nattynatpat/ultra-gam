...
///* generated l10n code */Scratch.translate.setup({"de":{"_Comment Blocks":"Kommentar Blöcke"},"fi":{"_Comment Blocks":"Kommenttilohkot","_comment":"kommentti"},"it":{"_Comment Blocks":"Blocchi per Commenti","_comment":"commento"},"ja":{"_Comment Blocks":"コメントブロック","_comment":"コメント"},"ko":{"_Comment Blocks":"주석 블록","_comment":"주석"},"nb":{"_Comment Blocks":"Kommentarblokker","_comment":"kommentar"},"nl":{"_Comment Blocks":"Commentaarblokken","_comment":"opmerking"},"ru":{"_Comment Blocks":"Блоки Комментариев","_comment":"комментарий"},"tr":{"_Comment Blocks":"Yorum Blokları"},"uk":{"_Comment Blocks":"Блоки-Коментарі"},"zh-cn":{"_Comment Blocks":"注释","_comment":"注释"}});/* end generated l10n code */(function (Scratch) {
    "use strict";
